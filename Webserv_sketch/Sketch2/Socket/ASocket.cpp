...
/*   Updated: 2024/09/11 15:36:15 by mmaria-d         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

# include "ASocket.hpp"

ASocket::ASocket(const int fd, const ISocketAddress& addr, bool closeOnDestruct) : FileDescriptor(fd, closeOnDestruct), _addr(addr.clone()) {}
...
// all private
ASocket::ASocket() : FileDescriptor(-1, false), _addr(NULL) {}
