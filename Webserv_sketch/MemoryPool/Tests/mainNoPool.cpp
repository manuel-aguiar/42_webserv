...
/*   Updated: 2024/09/25 08:07:46 by mmaria-d         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main123(int ac, char **av)
{
    ...
    typedef std::map<std::string, int>  PoolMap;
    typedef std::map<std::string, int>::iterator PoolMap_iter;
...
int main(int ac, char **av)
{
    ...
    typedef std::map<int, Dummy> Map;

    typedef std::list<Dummy>                    List;

    typedef std::set<Dummy>    Set;
