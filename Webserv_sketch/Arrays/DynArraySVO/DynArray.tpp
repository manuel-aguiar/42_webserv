...
/*   Updated: 2024/10/09 09:06:46 by mmaria-d         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    public:
        DynArraySVO(Allocator allocator = Allocator()) : m_array(NULL), m_size(0), m_capacity(0), m_allocator(allocator) {};
        DynArraySVO(int size, Allocator allocator = Allocator()) : m_array(NULL), m_size(size), m_capacity(size), m_allocator(allocator)
        {
        ...
        DynArraySVO(int size, T& value, const Allocator& allocator = Allocator())
        {
            m_array = m_allocator.allocate(size, NULL);
            for (int i = 0; i < size; i++)
        ...
        DynArraySVO(const DynArraySVO &other) : m_array(NULL), m_size(0), m_capacity(0), m_allocator(other.m_allocator)
        {
            *this = other;
        }
