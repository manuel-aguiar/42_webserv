...
int main(void)
{
    ...
    CgiStressTest::StressTest(testNumber, 2, 5, 4096, 1000, 50, &CgiStressTest::ValidPHP,"ValidPHP");
	CgiStressTest::StressTest(testNumber, 5, 5, 4096, 1000, 50, &CgiStressTest::AllInvalidCriteria, "AllInvalidCriteria");
