...
{
	scriptTest(testNumber, "../TestScripts/php/ValidPhP.php", "/usr/bin/php-cgi", TestProtoRequest::E_CGI_STATUS_SUCCESS);
	scriptTest(testNumber, "../TestScripts/php/ValidLongBody.php", "/usr/bin/php-cgi", TestProtoRequest::E_CGI_STATUS_SUCCESS);
	//scriptTest(testNumber, "../TestScripts/php/InvalidLongHeaders.php", "/usr/bin/php-cgi", TestProtoRequest::E_CGI_STATUS_ERROR);
	//scriptTest(testNumber, "../TestScripts/php/InvalidHeaders.php", "/usr/bin/php-cgi", TestProtoRequest::E_CGI_STATUS_ERROR);
}