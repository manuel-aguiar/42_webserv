...
/*   Updated: 2025/01/15 14:35:51 by mmaria-d         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	...
	//testNumber = CgiStressTest::StressTest(testNumber, 1, 1, 7, 15000, &CgiStressTest::InvalidInterpreter, "InvalidInterpreter");
	//testNumber = CgiStressTest::StressTest(testNumber, 1, 1, 3, 150000, &CgiStressTest::InvalidInterpreterPath, "InvalidInterpreterPath");
	//testNumber = CgiStressTest::StressTest(testNumber, 50, 100, 1000, 2000, &CgiStressTest::AllValidCriteria, "AllValidCriteria");
	...
	testNumber = CgiStressTest::StressTest(testNumber, 10, 100, 100, 15000, &CgiStressTest::AllInvalidCriteria, "AllInvalidCriteria");
	testNumber = CgiStressTest::StressTest(testNumber, 5, 100, 200, 50, &CgiStressTest::AllValidCriteria, "AllValidCriteria");
	testNumber = CgiStressTest::StressTest(testNumber, 5, 100, 200, 15000, &CgiStressTest::MixedCriteria, "MixedCriteria");
	testNumber = CgiStressTest::StressTest(testNumber, 5, 100, 200, 15000, &CgiStressTest::InvalidInterpreter, "InvalidInterpreter");
	testNumber = CgiStressTest::StressTest(testNumber, 5, 100, 200, 15000, &CgiStressTest::InvalidScript, "InvalidScript");
	testNumber = CgiStressTest::StressTest(testNumber, 5, 100, 200, 15000, &CgiStressTest::InvalidInterpreterPath, "InvalidInterpreterPath");
	testNumber = CgiStressTest::StressTest(testNumber, 5, 100, 1000, 15000, &CgiStressTest::AllInvalidCriteria, "AllInvalidCriteria");
	testNumber = CgiStressTest::StressTest(testNumber, 20, 300, 5000, 15000, &CgiStressTest::AllValidCriteria, "AllValidCriteria");
