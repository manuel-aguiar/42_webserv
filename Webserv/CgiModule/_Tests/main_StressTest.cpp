...
/*   Updated: 2025/01/17 11:48:57 by mmaria-d         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	...
	testNumber = CgiStressTest::StressTest(testNumber, 2, 5, 50, 5000, &CgiStressTest::AllValidCriteria, "AllValidCriteria");
	//testNumber = CgiStressTest::StressTest(testNumber, 50, 500, 5000, 50, &CgiStressTest::AllValidCriteria, "AllValidCriteria");
