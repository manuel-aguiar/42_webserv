...
/*   Updated: 2025/01/14 14:30:47 by mmaria-d         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	...
	testNumber = CgiStressTest::StressTest(testNumber, 10, 100, 100, 5000, &CgiStressTest::InvalidInterpreterPath, "InvalidInterpreterPath");
	testNumber = CgiStressTest::StressTest(testNumber, 10, 100, 100, 5000, &CgiStressTest::AllInvalidCriteria, "AllInvalidCriteria");
	testNumber = CgiStressTest::StressTest(testNumber, 10, 100, 100, 5000, &CgiStressTest::AllInvalidCriteria, "AllInvalidCriteria");
	//testNumber = CgiStressTest::StressTest(testNumber, 5, 100, 1000, 5000, &CgiStressTest::InvalidInterpreter, "InvalidInterpreter");
	//testNumber = CgiStressTest::StressTest(testNumber, 5, 100, 1000, 5000, &CgiStressTest::InvalidScript, "InvalidScript");
	//testNumber = CgiStressTest::StressTest(testNumber, 5, 100, 1000, 5000, &CgiStressTest::InvalidInterpreterPath, "InvalidInterpreterPath");
	//testNumber = CgiStressTest::StressTest(testNumber, 5, 100, 1000, 5000, &CgiStressTest::AllInvalidCriteria, "AllInvalidCriteria");
	testNumber = CgiStressTest::StressTest(testNumber, 5, 100, 1000, 5000, &CgiStressTest::AllValidCriteria, "AllValidCriteria");
