...
namespace Cgi
{
	...
	Cgi::Module::Module(size_t workers, size_t backlog, size_t maxTimeout, Events::Manager& eventManager, Globals& globals) :
	...
	Cgi::Module::Module(const Cgi::Module &copy) :
		m_timerTracker			(0),
		m_eventManager			(copy.m_eventManager),
		m_globals				(copy.m_globals) {}

	Cgi::Module& Cgi::Module::operator=(const Cgi::Module &assign) {(void)assign; return (*this);}
