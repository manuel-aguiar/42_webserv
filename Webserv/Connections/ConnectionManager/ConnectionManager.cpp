...
ConnectionManager::ConnectionManager(size_t maxConnections, Nginx_MemoryPool& borrowedPool, Globals& globals) :
	...
	m_readEvents(m_maxConnections, Nginx_PoolAllocator<Subscription>(borrowedPool)),
	m_writeEvents(m_maxConnections, Nginx_PoolAllocator<Subscription>(borrowedPool)),
