...
int main345(int ac, char **av)
{
    ...
    typedef SharedMPool_Dealloc<std::pair<int, ToolkitDummy> >      MapPool;
    typedef std::map<int, ToolkitDummy, std::less<int>, MapPool> Map;

    typedef SharedMPool_Dealloc<ToolkitDummy>                       ListPool;
    typedef std::list<ToolkitDummy, ListPool>                    List;

    typedef SharedMPool_Dealloc<ToolkitDummy>                       SetPool;
