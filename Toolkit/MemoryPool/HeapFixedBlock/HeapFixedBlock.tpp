...
{
    public:
        HeapFixedBlock(size_t blockSize, const Allocator& allocator = Allocator()) :
    ...
    private:
        ...
        HeapFixedBlock() : m_array(NULL), m_blockSize(0) {}
        HeapFixedBlock(const HeapFixedBlock& copy) : m_blockSize(copy.m_blockSize) {(void)copy;}
        HeapFixedBlock& operator=(const HeapFixedBlock& assign) {(void)assign; return (*this);}
