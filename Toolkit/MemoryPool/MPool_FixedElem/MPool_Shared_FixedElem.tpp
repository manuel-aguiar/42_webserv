...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   MPool_Shared_FixedElem.tpp                         :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: mmaria-d <mmaria-d@student.42lisboa.com    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/12/27 10:19:35 by mmaria-d          #+#    #+#             */
/*   Updated: 2025/01/06 11:39:47 by mmaria-d         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#ifndef MPOOL_SHARED_FIXEDELEM_TPP

# define MPOOL_SHARED_FIXEDELEM_TPP
...
class PoolAllocator_FixedElem
{
	public:
		...
		PoolAllocator_FixedElem(const PoolAllocator_FixedElem<U>& rebind) : 
			m_memoryPool(reinterpret_cast<MPool_FixedElem<T>*>(rebind.m_memoryPool))
		{
			/*
