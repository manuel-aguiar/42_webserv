...
/*   Updated: 2025/01/02 14:47:10 by mmaria-d         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int TestPart1(int testNumber)
{
	...
	try
	{
		...
		FixedSizeQueue<ToolkitDummy> 		array(100);
		...
		FixedSizeQueue<ToolkitDummy>::iterator it = array.begin();
...
/******************* ***** ************************/
	...
	try
	{
		std::cout << "TEST " << testNumber << ": ";
		std::vector<ToolkitDummy> 			std;
		FixedSizeQueue<ToolkitDummy> 			array(200);
